...
CONFIG.CATEGORIES.map(category => {
	categories[category] = {
		appenders: ['console', 'file'], level: CONFIG.LEVEL_LOG
	}
})
...
module.exports.getConectionsLogger = (app) => {
	...
	//define logger
	var logger = log4js.getLogger(CONFIG.CATEGORIES[0])
...
module.exports.Logger = (logLevel, logMessage, catalog) => {
	...
	var catalogIndex = catalog ? catalog : "TRACE"
	var logger = log4js.getLogger(CONFIG.CATEGORIES[catalogIndex])
