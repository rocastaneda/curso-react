...
const TextareaInput = ({error, noupper, lower, label, name, onChange, placeholder, readOnly, disabled, required, value, maxLength, alpha, alphanum, alphaQuestion, rows, style}) => {
